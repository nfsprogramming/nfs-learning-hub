...
let courseData = [];
let progress = JSON.parse(localStorage.getItem('course_progress_Web_Dev_For_Beginners')) || {};
...
function toggleComplete(lessonId) {
    ...
    localStorage.setItem('course_progress_Web_Dev_For_Beginners', JSON.stringify(progress));
    renderDashboard();
    updateOverallProgress();
}
...
function openNotebook(lessonPath, notebookName, lessonId) {
    const githubRepo = "microsoft/web-dev-for-beginners";
    const branch = "main";
